        ...
        <div className="flex items-center justify-between h-full px-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 px-3 py-1.5 bg-gray-100 rounded-lg">
              ...
              <span className="text-sm font-semibold text-slate-700 [font-family:'Inter',Helvetica]">
                {totalEvents}
              </span>
            </div>
          ...
          <div className="p-6">
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-slate-600 mb-3 [font-family:'Inter',Helvetica]">
                Utilisez l'IA pour rechercher en langage naturel
              </p>
              <div className="space-y-2 text-xs text-slate-500 [font-family:'Inter',Helvetica] mb-4">
                <p>Exemples :</p>
