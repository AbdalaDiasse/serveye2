...
// Import des icônes générées
import peopleIcon from "@assets/generated_images/People_group_icon_gradient_4a2e88ff.png";
import analyticsIcon from "@assets/generated_images/Analytics_chart_icon_gradient_f44ceb81.png";
import securityIcon from "@assets/generated_images/Security_shield_icon_gradient_72592f34.png";
        ...
        <div className="grid grid-cols-3 gap-6">
            ...
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <div className="bg-white/20 p-3 rounded-lg">
                  <img src={peopleIcon} alt="People" className="w-8 h-8" style={{background: 'none'}} />
                </div>
          ...
          <Card className="bg-emerald-500 text-white">
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <div className="bg-white/20 p-3 rounded-lg">
                  <img src={analyticsIcon} alt="Analytics" className="w-8 h-8" style={{background: 'none'}} />
                </div>
          ...
          <Card className="bg-red-500 text-white">
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <div className="bg-white/20 p-3 rounded-lg">
                  <img src={securityIcon} alt="Security" className="w-8 h-8" style={{background: 'none'}} />
                </div>
